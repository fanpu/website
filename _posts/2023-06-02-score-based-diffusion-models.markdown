...
\cite{generative-modeling-sde} shows that SMLD and DDPM actually corresponds to 
...
Another technique known as truncated diffusion probabilistic modeling (TDPM) \cite{truncated-diffusion-models}.
